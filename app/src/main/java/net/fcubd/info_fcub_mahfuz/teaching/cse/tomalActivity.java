...
public class tomalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText("Khandaker Takdir Ahmed\nLecturer\nDepartment of CSE\nFirst Capital University of Bangladesh, Chuadanga");
        staffs_academics.setText("*** M.Sc in I.C.E From Islamic University, Kushtia \n*** B.Sc in I.C.E From Islamic University, Kushtia");
        staffs_research.setText("*** Mobile Adhoc Networking\n*** Nano Technology\n*** Robotics.");
        staffs_experiences.setText("*** Working as a Lecturer in FCUB since January 15, 2015.");
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(tomalActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801719252243"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801719-252243");

        //staffs email
        staffs_email.setText("Email: iu0607@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"iu0607@gmail.com"};
        ...
        //image details
        teachers_img.setImageResource(R.drawable.tomal);
    }
}
