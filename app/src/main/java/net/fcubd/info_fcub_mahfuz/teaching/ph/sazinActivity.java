...
public class sazinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.sazin_position);
        staffs_academics.setText(R.string.sazin_education);
        staffs_research.setText(R.string.sazin_research);
        staffs_experiences.setText(R.string.sazin_experience);
        staffs_award.setText(R.string.no_info);
        staffs_publications.setText(R.string.sazin_publication);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(sazinActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801752000266"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801752000266");

        //staffs email
        staffs_email.setText("Email: meet.sazin@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"meet.sazin@gmail.com"};
        ...
        //image details
        teachers_img.setImageResource(R.drawable.sazin);
    }
}
