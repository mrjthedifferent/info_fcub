...
public class tohfaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.tohfa_position);
        staffs_academics.setText(R.string.tohfa_education);
        staffs_research.setText(R.string.no_info);
        staffs_experiences.setText(R.string.tohfa_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(tohfaActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801727226799"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801727226799");

        //staffs email
        staffs_email.setText("Email: No Email Available");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tohfaActivity.this, "No E-mail Available", Toast.LENGTH_LONG).show();
            }
        });
