...
public class tuhinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.tuhin_position);
        staffs_academics.setText(R.string.tuhin_education);
        staffs_research.setText(R.string.tuhin_research);
        staffs_experiences.setText(R.string.tuhin_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(tuhinActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801921287387"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801921287387");

        //staffs email
        staffs_email.setText("Email: lawyer_tuhin@yahoo.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"lawyer_tuhin@yahoo.com"};
        ...
        //image details
        teachers_img.setImageResource(R.drawable.tuhin);
    }
}
