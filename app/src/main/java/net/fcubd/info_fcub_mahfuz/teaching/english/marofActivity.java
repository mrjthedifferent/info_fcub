...
public class marofActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.marof_position);
        staffs_academics.setText(R.string.marof_education);
        staffs_research.setText(R.string.marof_research);
        staffs_experiences.setText(R.string.no_info);
        staffs_award.setText(R.string.no_info);
        staffs_publications.setText(R.string.marof_publication);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(marofActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801913590714"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801913590714");

        //staffs email
        staffs_email.setText("Email: marofeng1990@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"marofeng1990@gmail.com"};
