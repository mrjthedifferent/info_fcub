...
public class SayeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.sayeed_position);
        staffs_academics.setText(R.string.sayeed_education);
        staffs_research.setText(R.string.sayeed_research);
        staffs_experiences.setText(R.string.sayeed_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(SayeedActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801718149643"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801718149643");

        //staffs email
        staffs_email.setText("Email: smiqbalbd@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"smiqbalbd@gmail.com"};
        ...
        //image details
        teachers_img.setImageResource(R.drawable.sayeed);
    }
}
