...
public class farjanaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.farjana_position);
        staffs_academics.setText(R.string.farjana_education);
        staffs_research.setText(R.string.farjana_research);
        staffs_experiences.setText(R.string.farjana_experience);
        staffs_award.setText(R.string.no_info);
        staffs_publications.setText(R.string.tuhin_publication);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(farjanaActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801913064471"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801913064471");

        //staffs email
        staffs_email.setText("Email: farjanaboby199@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"farjanaboby199@gmail.com"};
        ...
        //image details
        teachers_img.setImageResource(R.drawable.farjana);
    }
}
