...
public class mehediActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.mehedi_position);
        staffs_academics.setText(R.string.mehedi_education);
        staffs_research.setText(R.string.no_info);
        staffs_experiences.setText(R.string.mehedi_experience);
        staffs_award.setText(R.string.no_info);
        staffs_publications.setText(R.string.mehedi_publication);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(mehediActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801918122776"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801918122776");

        //staffs email
        staffs_email.setText("Email: mhrlaw15@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"mhrlaw15@gmail.com"};
