...
public class mostafijurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.mostafiz_position);
        staffs_academics.setText(R.string.mostafiz_education);
        staffs_research.setText(R.string.mostafiz_research);
        staffs_experiences.setText(R.string.mostafiz_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(mostafijurActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801922973465"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801922973465");

        //staffs email
        staffs_email.setText("Email: mostafizrumgt@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"mostafizrumgt@gmail.com"};
