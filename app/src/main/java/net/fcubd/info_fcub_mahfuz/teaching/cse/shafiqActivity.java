...
public class shafiqActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.shafiq_position);
        staffs_academics.setText(R.string.shafiq_education);
        staffs_research.setText(R.string.shafiq_research);
        staffs_experiences.setText(R.string.shafiq_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(shafiqActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801742354934"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801742354934");

        //staffs email
        staffs_email.setText("Email: shafiqcseiu07@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"shafiqcseiu07@gmail.com"};
