...
public class mahmudulActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.mahmudul_position);
        staffs_academics.setText(R.string.mahmudul_education);
        staffs_research.setText(R.string.mahmudul_research);
        staffs_experiences.setText(R.string.mahmudul_experience);
        staffs_award.setText(R.string.no_info);
        staffs_publications.setText(R.string.mahmudul_publication);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(mahmudulActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801735959054"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801735959054");

        //staffs email
        staffs_email.setText("Email: jewelgono@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"jewelgono@gmail.com"};
