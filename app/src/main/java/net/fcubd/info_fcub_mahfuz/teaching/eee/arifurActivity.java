...
public class arifurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.ariful_position);
        staffs_academics.setText(R.string.ariful_education);
        staffs_research.setText(R.string.ariful_research);
        staffs_experiences.setText(R.string.ariful_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(arifurActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:++8801917813747"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801917813747");

        //staffs email
        staffs_email.setText("Email: uzzalruapee@gmail.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"uzzalruapee@gmail.com"};
        ...
        //image details
        teachers_img.setImageResource(R.drawable.arifur);
    }
}
