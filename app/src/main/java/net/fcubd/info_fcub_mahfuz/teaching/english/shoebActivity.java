...
public class shoebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.imroj_position);
        staffs_academics.setText(R.string.imroj_education);
        staffs_research.setText(R.string.no_info);
        staffs_experiences.setText(R.string.imroj_experience);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(shoebActivity.this);
        ...
        //staffs email
        staffs_email.setText("Email: imrojmohammad@yahoo.com");
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] to = {"imrojmohammad@yahoo.com"};
