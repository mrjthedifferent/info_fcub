...
public class vcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.vice_chancellor);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(vcActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+88076163899"));
                        startActivity(i);
                    }
                });
                ...
                call2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(vcActivity.this, "You can't send messages to this number", Toast.LENGTH_LONG).show();
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +88076163899");
        ...
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(vcActivity.this, "No E-mail Available", Toast.LENGTH_LONG).show();
            }
        });

        //image details
        teachers_img.setImageResource(R.drawable.vc);
    }
}
