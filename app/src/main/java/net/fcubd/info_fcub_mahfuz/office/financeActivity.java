...
public class financeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.director_of_finance_position);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(financeActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801960569441"));
                        startActivity(i);
                    }
                });
        ...
        staffs_mobile.setText("Telephpne: +8801960569441");
        ...
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(financeActivity.this, "No E-mail Available", Toast.LENGTH_LONG).show();
            }
        });
