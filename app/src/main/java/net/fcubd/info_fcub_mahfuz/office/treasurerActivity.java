...
public class treasurerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.treasurer_position);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(treasurerActivity.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Intent.ACTION_CALL, Uri.parse("tel:+8801552303071"));
                        startActivity(i);
                    }
                });
                ...
                call2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        {
                            String number = "+8801552303071";  // The number on which you want to send SMS
        ...
        staffs_mobile.setText("Telephpne: +8801552303071");
        ...
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(treasurerActivity.this, "No E-mail Available", Toast.LENGTH_LONG).show();
            }
        });
