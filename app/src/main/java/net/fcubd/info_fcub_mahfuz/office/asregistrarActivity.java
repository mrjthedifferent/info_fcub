...
public class asregistrarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffs_position.setText(R.string.assistant_registrar_position);
        ...
        staffs_mobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final Dialog dialog = new Dialog(asregistrarActivity.this);
        ...
        staffs_mobile.setText("Telephpne: +8801983278199");
        ...
        staffs_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(asregistrarActivity.this, "No E-mail Available", Toast.LENGTH_LONG).show();
            }
        });
